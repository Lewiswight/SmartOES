   ...
   #             
    ...
    def upload_data(self):
        ...
        if self.uploading == 0:
            ...
            print "already uploading data right now, try again later"
    ...
    def __send_to_idigi(self, data):
        ...
        try:
            ...
            webservice = httplib.HTTP("mistaway.houselynx.co")
        #    print "line 1"
        ...
        #    print "line 2"
            webservice.putheader(unicode("Host", "utf-8" ), unicode("mistaway.houselynx.co", "utf-8" ))
