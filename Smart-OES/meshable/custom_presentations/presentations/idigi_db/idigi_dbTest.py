   ...
   #             
    ...
    #    print SoapMessage
        ...
        try:
            ...
            self.webservice = httplib.HTTP("mysmartfuel.houselynx.co")
            print "line 1"
            self.webservice.putrequest(unicode("POST", "utf-8" ), unicode("/UploadDump.asmx", "utf-8" ), "HTTP/1.1")
        #        webservice.putheader("POST", "/NumericUpDown.asmx", "" )
            print "line 2"
            self.webservice.putheader(unicode("Host", "utf-8" ), unicode("mysmartfuel.houselynx.co", "utf-8" ))
        #        webservice.putheader("User-Agent: ", "Python Post")
            print "line 3"
            self.webservice.putheader(unicode("Content-Type", "utf-8" ), unicode("text/xml; charset=\"UTF-8\"", "utf-8" ))
            print "line 4"
            self.webservice.putheader(unicode("Content-Length", "utf-8" ), unicode("%d", "utf-8" ) % len(SoapMessage))
            print "line 5"
            self.webservice.putheader(unicode("SOAPAction", "utf-8" ), unicode("\"http://houselynx.com/webservices/XMLparser\"", "utf-8" ))
            print "line 6"
            self.webservice.endheaders()
            print "line 7"
   #         self.webservice.send(unicode(SoapMessage, "utf-8" ))
